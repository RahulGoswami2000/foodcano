...
class CanteenSignupPage extends StatelessWidget {
  const CanteenSignupPage({Key? key}) : super(key: key);

  static const String _title = 'Canteen SignUp Page';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const CanteenSignupPageUI(),
      ),
    );
  }
}

class CanteenSignupPageUI extends StatefulWidget {
  const CanteenSignupPageUI({Key? key}) : super(key: key);

  @override
  _CanteenSignupPageUIState createState() => _CanteenSignupPageUIState();
}

class _CanteenSignupPageUIState extends State<CanteenSignupPageUI> {
